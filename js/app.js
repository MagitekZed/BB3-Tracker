...
window.openPlayoffsManager = openPlayoffsManager;
...
window.teamDevRollRandomSkills = teamDevRollRandomSkills;
window.teamDevChooseRandomSkill = teamDevChooseRandomSkill;
...
window.revertMostRecentTeamChange = revertMostRecentTeamChange;
window.teamRedraftReset = teamRedraftReset;
window.teamRedraftBack = teamRedraftBack;
window.teamRedraftNext = teamRedraftNext;
window.teamRedraftSetRecoveryRoll = teamRedraftSetRecoveryRoll;
window.teamRedraftSetCapEnabled = teamRedraftSetCapEnabled;
window.teamRedraftToggleRehire = teamRedraftToggleRehire;
window.teamRedraftShowPlayerInfo = teamRedraftShowPlayerInfo;
window.teamRedraftAddNewHire = teamRedraftAddNewHire;
window.teamRedraftRemoveNewHire = teamRedraftRemoveNewHire;
window.teamRedraftSetStaffField = teamRedraftSetStaffField;
window.teamRedraftFinalize = teamRedraftFinalize;
...
window.postGameRerender = postGameRerender;
window.pgSetNoStalling = pgSetNoStalling;
window.pgSetWinningsOverrideK = pgSetWinningsOverrideK;
window.pgSetDedicatedFansRoll = pgSetDedicatedFansRoll;
window.pgSetDedicatedFansDeltaOverride = pgSetDedicatedFansDeltaOverride;
window.pgToggleMvpNominee = pgToggleMvpNominee;
window.pgSetMvpRoll = pgSetMvpRoll;
window.pgAddAdvancement = pgAddAdvancement;
window.pgRemoveAdvancement = pgRemoveAdvancement;
window.pgUpdateAdvancement = pgUpdateAdvancement;
window.pgRollRandomSkills = pgRollRandomSkills;
window.pgChooseRandomSkill = pgChooseRandomSkill;
window.pgSetInjuryOutcome = pgSetInjuryOutcome;
window.pgToggleTempRetire = pgToggleTempRetire;
window.pgSetStaffField = pgSetStaffField;
window.pgSetOtherTreasuryDeltaK = pgSetOtherTreasuryDeltaK;
window.pgToggleHireJourneyman = pgToggleHireJourneyman;
window.pgSetHireJourneymanField = pgSetHireJourneymanField;
window.pgSetExpensiveField = pgSetExpensiveField;
